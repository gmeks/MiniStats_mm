...
BINARY = MiniStats_mm_i486.so

OBJECTS = HLStatsX.cpp SrvConsoleCmds.cpp EvenListeners.cpp cvars.cpp Stats.cpp SharedFunctions.cpp SteamIDList.cpp \
	hl2sdk/recipientfilters.cpp \	

LINK = ../sdk/HL2Sdk/linux_sdk/tier1_i486.a vstdlib_i486.so
